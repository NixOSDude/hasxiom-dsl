...
-- at runtime using the environment variable hasxiom_dsl_bindir.
...
-- environment variable hasxiom_dsl_libdir.
...
-- using the environment variable hasxiom_dsl_dynlibdir.
...
-- runtime using the environment variable hasxiom_dsl_datadir.
...
-- variable hasxiom_dsl_libexedir.
...
-- using the environment variable hasxiom_dsl_sysconfdir.
...
bindir     = "/home/nixdude/.cabal/bin"
libdir     = "/home/nixdude/.cabal/lib/x86_64-linux-ghc-9.10.3-a85d/hasxiom-dsl-0.1.0.0-inplace-compute-depth"
dynlibdir  = "/home/nixdude/.cabal/lib/x86_64-linux-ghc-9.10.3-a85d"
datadir    = "/home/nixdude/.cabal/share/x86_64-linux-ghc-9.10.3-a85d/hasxiom-dsl-0.1.0.0"
libexecdir = "/home/nixdude/.cabal/libexec/x86_64-linux-ghc-9.10.3-a85d/hasxiom-dsl-0.1.0.0"
sysconfdir = "/home/nixdude/.cabal/etc"

getBinDir     = catchIO (getEnv "hasxiom_dsl_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "hasxiom_dsl_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "hasxiom_dsl_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "hasxiom_dsl_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hasxiom_dsl_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hasxiom_dsl_sysconfdir") (\_ -> return sysconfdir)
